...
import '../models/auth/user/forget_password/forgot_password_response.dart';
import '../models/auth/user/forget_password/verify_forgot_password_otp_request.dart';
import '../models/auth/user/forget_password/verify_forgot_password_otp_response.dart';
import '../models/auth/user/forget_password/reset_password_request.dart';
import '../models/auth/user/forget_password/reset_password_response.dart';
...
abstract class RestClient {
  ...
  @POST('')
  Future<BaseResponse<UserData>> loginUser(@Query('path') String path,
      @Body() Map<String, dynamic> request,);

  @POST('')
  Future<BaseResponse<UserData>> registerUser(@Query('path') String path,
      @Body() Map<String, dynamic> request,);
  ...
  @GET('')
  Future<BaseResponse<List<CityModel>>> getCities(@Query('path') String path,
  ...
  @POST('')
  Future<BaseResponse<VerifyForgotPasswordOtpResponse>>
  verifyForgotPasswordOtp(@Query('path') String path,
      @Body() VerifyForgotPasswordOtpRequest request,);
